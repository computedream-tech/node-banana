...
function ProviderBadge({ provider }: { provider: ProviderType }) {
  const providerNames: Record<string, string> = {
    gemini: "Gemini", replicate: "Replicate", fal: "fal.ai", wavespeed: "WaveSpeed", openai: "OpenAI",
  };

  return (
    <span className="text-neutral-500 shrink-0" title={providerNames[provider] || provider}>
      {provider === "gemini" ? (
